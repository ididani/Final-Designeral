...
router.post("/:userId/add", async (req, res) => {
  ...
  console.log(
    `Adding item to cart for user: ${userId}, product: ${productId}, quantity: ${quantity}`
  );
  ...
  try {
    ...
    if (!cart) {
      cart = new Cart({ userId, items: [{ productId: product._id, quantity }] });
    } else {
...
router.put("/:userId/item/:productId/update", async (req, res) => {
  ...
  console.log(
    `Updating cart for user: ${userId}, product: ${productId}, quantity: ${quantity}`
  );
